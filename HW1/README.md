...
## Task Summary
The original coursework asked students to complete the P&R flow in Innovus, optimize timing/area, compare congestion-driven and timing-driven placement, explain filler-cell insertion, and report slack, area, wirelength, and DRC results.
...
### Best result layout
![Best result layout](https://github.com/r08b46009/VLSI/blob/main/HW1/figures/HW1.png)
## Disclaimer
